...
% ============================================================
\subsection{1. Tokenizer Verification (3pts)}
...
% ============================================================
\subsection{2. Indexer Verification}
...
% ============================================================
\subsection{3. Query Processor Verification}
...
% ============================================================
\subsection{4. Full System Timeline Verification}
...
% ============================================================
\subsection{4. Full System Timeline Test (Optional)}
\textbf{Goal:} Run all assignment tasks automatically (tokenization, indexing, and retrieval).

\begin{lstlisting}[language=bash]
./run_docker.sh cli.py timeline --csv data/
\end{lstlisting}

\textbf{Excerpt of Output:}
\begin{lstlisting}
[Task 11/12] Testing BM25 (+1pt)...
  10 results, top score: 11.858 | Top 3:
    Peter and Vandy; I Love You, I Love You Not; A Journal for Jordan
[Task 12/12] Testing Language Model (+1pt)...
  5 results, top score: -19.555 | Top 3:
    The Lost Valentine; Isn't It Romantic; God of Love
---------------------------------------------------------------------------
Summary: 12/12 tasks completed successfully
\end{lstlisting}

This confirms the complete IR pipeline (Tokenizer → Indexer → Query Processor)
runs reproducibly inside Docker with full functionality verified.
...
The following figures show the actual command-line outputs captured during the final
system run inside the Docker container. They visually confirm that all components
(Tokenization, Indexing, Query Processing) were executed correctly and that the 
retrieval engine passed all twelve rubric tasks.

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{images/evaulation1.png}
  \caption{Tokenizer and Indexer execution logs (SPIMI, Disk, and Updatable modes).}
  \label{fig:appendix-indexer}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{images/evaulation2.png}
  \caption{Updatable index operations — insert, update, and delete verification.}
  \label{fig:appendix-updatable}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{/images/evaluation2.png}
\begin{figure}
      \centering
      \includegraphics[width=0.5\linewidth]{/images/evaluation3.png}
      \caption{Enter Caption}
      \label{fig:placeholder}
  \end{figure}
    \caption{Final timeline summary showing all 12 tasks completed successfully.}
...
\begin{itemize}
  \item Figure~\ref{fig:appendix-indexer}: Index construction and vocabulary statistics.
  \item Figure~\ref{fig:appendix-updatable}: Dynamic index maintenance operations.
  \item Figure~\ref{fig:appendix-timeline}: Final evaluation summary (12/12 tasks passed).
\end{itemize}
\end{document}
